...
class LoginUsuarioTests(APITestCase):
    ...
    def test_login_com_username_e_senha_validos(self):
        response = self.client.post(
            self.url,
    ...
    def test_login_com_email_e_senha_validos(self):
        response = self.client.post(
            self.url,
            {'username': 'usuario@example.com', 'password': 'SenhaForte123!'},
            format='json',
        )
    ...
    def test_login_rejeita_credenciais_invalidas(self):
        response = self.client.post(
            self.url,
            {'username': 'usuario_teste', 'password': 'SenhaErrada321!'},
            format='json',
        )
    ...
    def test_login_com_email_inexistente_rejeita_credenciais(self):
        response = self.client.post(
            self.url,
            {'username': 'email-nao-existe@example.com', 'password': 'SenhaForte123!'},
            format='json',
        )
